        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(ansText.equals(answers[flag])){
                    correct++;
                    Toast.makeText(QuestionActivity.this, "Hurray!! it was correct", Toast.LENGTH_LONG).show();

                }else {
                    wrong++;
                    Toast.makeText(QuestionActivity.this, "Ohh!! it was incorrect", Toast.LENGTH_LONG).show();
                }
                flag++;
                if(score!= null){
